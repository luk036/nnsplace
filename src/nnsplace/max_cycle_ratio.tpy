...
def max_cycle_ratio(G: nx.DiGraph, dist, update_ok, r0, care_io=False):
    """[summary]
    ...
    def calc_weight(r, e):
        ...
        """
        u, v = e
        return floor(r * G[u][v]['time'] - G[u][v]['cost'])
    ...
    # C0 = nx.find_cycle(G)
    # r0 = calc_ratio(C0)
    return min_parametric(G, r0, calc_weight, calc_ratio, dist,
                          update_ok, io=care_io)
