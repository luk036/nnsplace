...
from nnsplace import __version__
from nnsplace.MLPartMgr import MLBiPartMgr
from nnsplace.netlist import Netlist, create_random_hgraph
...
def parse_args(args):
    ...
    parser.add_argument(
        "--version", action="version", version="nnsplace {ver}".format(ver=__version__)
    )
